    ...
    <div className="mx-auto grid max-w-[1280px] gap-6 md:grid-cols-2 lg:grid-cols-3">
      {tiers.map((tier, i) => {
        ...
        return (
          <div
            key={tier.name}
            className={`reveal group relative overflow-hidden rounded-xl border ${metal.border} ${metal.borderHover} p-7 opacity-0 translate-y-6 transition-all duration-700 ease-out hover:-translate-y-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),inset_0_-1px_0_rgba(0,0,0,0.45),0_18px_40px_-12px_rgba(0,0,0,0.55)]`}
